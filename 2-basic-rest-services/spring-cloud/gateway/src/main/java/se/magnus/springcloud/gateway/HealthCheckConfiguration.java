...
public class HealthCheckConfiguration {
    ...
    ReactiveHealthIndicator healthcheckMicroservices() {
        ...
        registry.register("reaction",    () -> getHealth("http://reaction"));
        registry.register("comment",            () -> getHealth("http://comment"));
        registry.register("image",            () -> getHealth("http://image"));
        registry.register("post-composite", () -> getHealth("http://post-composite"));
