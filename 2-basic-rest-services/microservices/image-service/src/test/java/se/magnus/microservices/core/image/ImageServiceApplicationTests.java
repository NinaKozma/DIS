...
@SpringBootTest(webEnvironment = RANDOM_PORT, properties = { "spring.datasource.url=jdbc:h2:mem:image-db" })
...
public class ImageServiceApplicationTests {
	...
	private WebTestClient.BodyContentSpec getAndVerifyImagesByPostId(String postIdQuery,
